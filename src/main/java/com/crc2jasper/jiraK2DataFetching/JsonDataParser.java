...
public class JsonDataParser {
    ...
    private static final ObjectMapper OBJECT_MAPPER = SystemIni.getObjectMapper();
...
//                    relationship = relationship.replaceAll("\\s+", " ");
    ...
    private static boolean isCurrentBatch(JsonNode fields){
        ...
        return promoSchedule.contains(PROMOTION_RELEASE.getYear() + "-" + PROMOTION_RELEASE.getBatch());
    }
